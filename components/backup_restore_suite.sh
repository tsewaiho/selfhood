...
apt-get install -y libarchive-tools wget bzip2
...
restic_download_link[amd64]=https://github.com/restic/restic/releases/download/v0.13.1/restic_0.13.1_linux_amd64.bz2
restic_download_link[arm64]=https://github.com/restic/restic/releases/download/v0.13.1/restic_0.13.1_linux_arm64.bz2
